...
// Check locL STORAGE FOR BEST SCORES. 
...
function updateBestScore(){
  ...
  if (questionAmount == score.questions) {
    // return best score as number one dec
...
// Stop timer, prosess results, go to score page
function checkTime(){
  if (playerGuessArray.length == questionAmount){
  // console.log('player guess array', playerGuessArray);
    clearInterval(timer);
    // check for wrong guesses add panalty time
...
// Add a tenth of a sev to timeplayed
function addTime(){
  timePlayed += 0.1;
  checkTime();
}
